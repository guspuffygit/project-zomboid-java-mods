    ...
    ISBaseTimedAction.perform = function(self)
        ...
        if player and self.Type then
            ...
            if self.Type == "ISTakeGenerator" then
                local message = logutils.GetLogLinePrefix(player, "taken IsoGenerator")
                    .. " (appliances_misc_01_0) at "
                    .. location
            ...
            elseif self.Type == "ISToggleStoveAction" then
                local message = logutils.GetLogLinePrefix(player, "stove.toggle")
                    .. " @ "
                    .. location
                logutils.WriteLog(logutils.filemask.cmd, message)
            elseif self.Type == "ISPlaceCampfireAction" then
                local message = logutils.GetLogLinePrefix(player, "added Campfire")
                    .. " (camping_01_6) at "
                    .. location
                logutils.WriteLog(logutils.filemask.map, message)
                if SandboxVars.LogExtender.AlternativeMap then
            ...
            elseif self.Type == "ISRemoveCampfireAction" then
                local message = logutils.GetLogLinePrefix(player, "taken Campfire")
                    .. " (camping_01_6) at "
                    .. location
                logutils.WriteLog(logutils.filemask.map, message)
                if SandboxVars.LogExtender.AlternativeMap then
            ...
            elseif
                self.Type == "ISLightFromKindle"
                or self.Type == "ISLightFromLiterature"
                or self.Type == "ISLightFromPetrol"
            then
                local message = logutils.GetLogLinePrefix(player, "campfire.light")
                    .. " @ "
                    .. location
                logutils.WriteLog(logutils.filemask.cmd, message)
            elseif self.Type == "ISPutOutCampfireAction" then
                local message = logutils.GetLogLinePrefix(player, "campfire.extinguish")
                    .. " @ "
                    .. location
                logutils.WriteLog(logutils.filemask.cmd, message)
            elseif self.Type == "ISRemoveTrapAction" then
                local message = logutils.GetLogLinePrefix(player, "taken Trap")
                    .. " ("
                    .. self.trap.openSprite
                    .. ") at "
                    .. location
                logutils.WriteLog(logutils.filemask.map, message)
                if SandboxVars.LogExtender.AlternativeMap then
            ...
            elseif self.Type == "ISCraftAction" then
                ...
                local message = logutils.GetLogLinePrefix(player, "crafted")
                    .. " "
                    .. resultCount
                    .. " "
                    .. resultType
            ...
            if SandboxVars.LogExtender.AlternativeMap then
                ...
                if self.Type == "ISDestroyStuffAction" then
                    ...
                    if objName == "" then
                        objName = instanceof(self.item, "IsoThumpable") and "IsoThumpable"
                            or "undefined"
                    end

                    local message = logutils.GetLogLinePrefix(player, "removed " .. objName)
                        .. " ("
                        .. spriteName
                        .. ") at "
                        .. objLocation
                ...
                elseif self.Type == "ISMoveablesAction" then
                    ...
                    then
                        ...
                        local message = logutils.GetLogLinePrefix(
                            player,
                            "disassembled " .. objName
                        ) .. " (" .. spriteName .. ") at " .. objLocation .. " (" .. location .. ")"
                        logutils.WriteLog(logutils.filemask.map_alternative, message)
                    end
                    ...
                    if self.mode and self.mode == "pickup" and self.moveProps then
                        ...
                        local message = logutils.GetLogLinePrefix(player, "pickedup " .. objName)
                            .. " ("
                            .. spriteName
                            .. ") at "
                            .. objLocation
