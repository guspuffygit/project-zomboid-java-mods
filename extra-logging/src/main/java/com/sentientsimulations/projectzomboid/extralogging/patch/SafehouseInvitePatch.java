...
import com.sentientsimulations.projectzomboid.extralogging.events.SafehouseInviteSentEvent;
...
/**
 * Patches {@link zombie.network.packets.safehouse.SafehouseInvitePacket} to dispatch an event when
 * a safehouse invite is sent.
 */
public class SafehouseInvitePatch extends StormClassTransformer {

    public SafehouseInvitePatch() {
        super("zombie.network.packets.safehouse.SafehouseInvitePacket");
    }
