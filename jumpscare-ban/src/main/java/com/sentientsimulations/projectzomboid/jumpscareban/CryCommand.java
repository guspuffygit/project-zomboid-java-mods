...
public class CryCommand extends CommandBase {
    ...
    protected String Command() {
        if (this.getCommandArgsCount() == 0) {
            ...
            GameServer.sendServerCommand("JumpscareBan", "playCry", AdminSoundArgs.forEveryone());
        ...
        GameServer.sendServerCommand("JumpscareBan", "playCry3D", AdminSoundArgs.forPlayer(player));
