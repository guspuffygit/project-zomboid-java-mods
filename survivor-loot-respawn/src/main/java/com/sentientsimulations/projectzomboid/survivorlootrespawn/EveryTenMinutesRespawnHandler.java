...
//
// import
// com.sentientsimulations.projectzomboid.survivorlootrespawn.config.SurvivorLootRespawnConfig;
// import
// com.sentientsimulations.projectzomboid.survivorlootrespawn.metrics.SurvivorLootRespawnMetrics;
// import com.sentientsimulations.projectzomboid.survivorlootrespawn.state.ContainerLootState;
// import
// com.sentientsimulations.projectzomboid.survivorlootrespawn.state.ContainerLootStateRepository;
// import
// com.sentientsimulations.projectzomboid.survivorlootrespawn.state.SurvivorLootRespawnDatabase;
...
public final class EveryTenMinutesRespawnHandler {
    ...
    public static void onEveryTenMinutes(EveryTenMinutesEvent event) {
        ...
        //                                queuedByChunk.get(
        //                                        ContainerLootStateRepository.chunkKey(chunk.wx,
        // chunk.wy));
        //                        if (queued == null) {
        //                            continue;
        //                        }
